 ...
 * @author jezek2
 */
// abstract class ContactSolverFunc {
// 	double resolveContact(RigidBody body1, RigidBody body2, ManifoldPoint contactPoint, ContactSolverInfo info);
// }

typedef ContactSolverFunc = double Function(RigidBody? body1, RigidBody? body2, ManifoldPoint? contactPoint, ContactSolverInfo? info);
